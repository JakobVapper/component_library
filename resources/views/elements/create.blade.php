                    ...
                    <div>
                        ...
                        <form action="{{ route('elements.store') }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="mt-1 block w-full rounded-lg border-gray-700 bg-gray-800 text-white shadow-sm focus:border-white focus:ring-white">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="content" id="content" rows="3" class="mt-1 block w-full rounded-lg border-gray-700 bg-gray-800 text-white shadow-sm focus:border-white focus:ring-white">{{ old('content') }}</textarea>
                                <p class="mt-1 text-sm text-gray-400">Explain what this element does and how to use it.</p>
                            </div>
                            
                            <div class="mb-6">
                                <label for="code" class="block text-sm font-medium text-gray-300 mb-1 required">HTML Code</label>
                                <textarea name="code" id="code" rows="10" class="font-mono mt-1 block w-full rounded-lg border-gray-700 bg-gray-800 text-white shadow-sm focus:border-white focus:ring-white">{{ old('code') }}</textarea>
